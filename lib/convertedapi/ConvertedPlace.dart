...
class ConvertedPlace {
  ...
  ConvertedPlace.fromJson(dynamic json) {
    _code = json['code'];
  ...
  String? _message;
  Data? _data;
  ConvertedPlace copyWith({  num? code,
    String? message,
    Data? data,
  }) => ConvertedPlace(  code: code ?? _code,
...
class Data {
  ...
  Data copyWith({  List<InnerData>? data,
    Pagination? pagination,
